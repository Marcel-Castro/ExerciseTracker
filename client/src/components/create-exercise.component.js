...
export default class CreateExercise extends Component {
    ...
    /*
    Ask Denis about making the card a seperate component
        - If yes, does putting it in a seperate file mean I need the imports for it here and in its own file?
        - The tutorial mentioned not making it a class component, thoughts?
    */
